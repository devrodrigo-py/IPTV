...
abstract class AppLocalizations {
  ...
  /// Playlists/sources navigation label
  ///
  /// In pt, this message translates to:
  /// **'Fontes'**
  String get playlists;

  /// EPG navigation label
  ///
  /// In pt, this message translates to:
  /// **'Programação'**
  String get epg;
  ...
  /// Message shown on home when no playlists are configured
  ///
  /// In pt, this message translates to:
  /// **'Importe uma playlist para começar'**
  ...
  /// In pt, this message translates to:
  /// **'Português (BR)'**
  String get settingsLanguagePtBr;
